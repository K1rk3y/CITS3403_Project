...
class RegistrationForm(FlaskForm):
    ...
    role = SelectField('Role', choices=[('Homecook', 'Homecook'), ('Patron', 'Patron')], validators=[DataRequired()])
...
class SearchForm(FlaskForm):
    ...
    mealType = StringField('Meal Type', validators=[Optional()])
    numOfMeals = IntegerField('No. of Meals', validators=[Optional()])
