################################################################################
### A line is marked as "STAR" if there is a potential problem
################################################################################
...
# openai.api_key = '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'
...
def get_hyperlinks(url):
    ...
    try:
        ...
        with urllib.request.urlopen(url) as response:
            ...
            # If the response is not HTML, return an empty list (STAR)
            if not response.info().get_content_type().startswith("text/html"):
                return []
